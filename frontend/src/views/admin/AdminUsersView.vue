        ...
        <div class="flex min-h-[382px] flex-col p-5 sm:p-6 lg:p-7">
          <div class="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
            <div class="min-w-0 max-w-4xl">
              ...
              <p class="mt-4 max-w-2xl text-sm font-semibold leading-7 text-white/90 sm:text-base">
                Gestión de accesos, roles y estado de las cuentas.
              </p>
            </div>
          ...
          <div class="mt-6 grid items-stretch gap-4 sm:grid-cols-2 xl:mt-auto xl:grid-cols-4">
            <article
              ...
              :key="card.key"
              class="flex h-full min-h-[152px] flex-col rounded-[24px] border border-white/16 bg-white/12 p-4 text-left backdrop-blur-sm"
            >
        ...
        <div class="flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
          <div>
            ...
            <p class="mt-2 text-sm leading-6 text-slate-500">
              Busca por nombre o correo y filtra por rol o estado.
            </p>
          </div>
                  ...
                  <td class="px-4 py-4">
                    <div class="flex items-center justify-end gap-1.5">
                      ...
                      <button
                        ...
                        class="inline-flex h-9 min-w-[86px] items-center justify-center whitespace-nowrap rounded-2xl px-3 text-[11px] font-semibold transition"
            ...
            >
              ...
              <div class="mt-5 flex flex-wrap gap-2">
                ...
                <button
                  type="button"
                  @click="toggleUserStatus(user)"
                  class="inline-flex h-10 flex-1 items-center justify-center whitespace-nowrap rounded-2xl px-4 text-xs font-semibold transition"
                  :class="user.status === 'active' ? 'bg-red-50 text-red-600 hover:bg-red-100' : 'bg-emerald-50 text-emerald-700 hover:bg-emerald-100'"
                >
                  {{ user.status === 'active' ? 'Desactivar' : 'Activar' }}
                </button>
          ...
          <div class="flex items-start justify-between gap-4">
            <div>
              <p class="text-xs font-bold uppercase tracking-[0.18em] text-[#9D7BC2]">
                {{ editingUserId ? 'Editar cuenta' : 'Nuevo usuario' }}
              </p>
...
const users = ref([
  {
    id: 1,
    name: 'Yana Chenko',
    email: 'yana@ladralab.test',
    phone: '600 123 456',
    role: 'admin',
    status: 'active',
    last_login_at: '2026-04-27T09:12:00',
  },
  {
    id: 2,
    name: 'Victoria Martín',
    email: 'victoria@ladralab.test',
    phone: '600 234 567',
    role: 'admin',
    status: 'active',
    last_login_at: '2026-04-26T17:45:00',
  },
  {
    id: 3,
    name: 'Nora Pérez',
    email: 'nora@ladralab.test',
    phone: '600 345 678',
    role: 'staff',
    status: 'active',
    last_login_at: '2026-04-27T08:20:00',
  },
  {
    id: 4,
    name: 'Diego Ramos',
    email: 'diego@ladralab.test',
    phone: '600 456 789',
    role: 'staff',
    status: 'active',
    last_login_at: '2026-04-27T13:08:00',
  },
  {
    id: 5,
    name: 'Marta Suárez',
    email: 'marta@ladralab.test',
    phone: '600 567 890',
    role: 'staff',
    status: 'inactive',
    last_login_at: '2026-03-14T11:30:00',
  },
  {
    id: 6,
    name: 'Claudia Vega',
    ...
    role: 'cliente',
    status: 'active',
    last_login_at: '2026-04-25T19:22:00',
  },
  {
    id: 7,
    name: 'Sergio Medina',
    ...
    role: 'cliente',
    status: 'active',
    last_login_at: '2026-04-26T10:04:00',
  },
  {
    id: 8,
    name: 'Lucía Castro',
    ...
    role: 'cliente',
    status: 'active',
    last_login_at: '2026-04-21T16:15:00',
  },
])
...
const roleCards = computed(() => [
  ...
  },
  {
    ...
    value: users.value.filter((user) => user.role === 'cliente').length,
  },
])
...
function saveUser() {
  if (editingUserId.value) {
    ...
    showToast('Usuario actualizado', 'Los cambios se han guardado en el mock.', 'success')
  } else {
    ...
    showToast('Usuario creado', 'La cuenta se ha añadido al listado de prueba.', 'success')
  }
